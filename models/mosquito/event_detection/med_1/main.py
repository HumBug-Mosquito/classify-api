...
from models.mosquito.event_detection.med_1.framework.models import MTRCNN_pad_half
...
class Med1(SupportedModel):
    ...
    def load(self):
        ...
        pretrained_model = torch.load(model_path, map_location=self.device, weights_only=False)
